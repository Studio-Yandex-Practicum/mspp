...
ENV_INFO = {
    "project_id": env("GOOGLE_PROJECT_ID", default="_"),
    "private_key_id": env("GOOGLE_PRIVATE_KEY_ID", default="_"),
    "private_key": env.str("GOOGLE_PRIVATE_KEY", multiline=True, default="_"),
    "client_email": env("GOOGLE_CLIENT_EMAIL", default="_"),
    "client_id": env("GOOGLE_CLIENT_ID", default="_"),
    "client_x509_cert_url": env("GOOGLE_CLIENT_X509_CERT_URL", default="_"),
}
